...
const de = {
  ...
  'vr3.list.card.openAria': '{name} öffnen',
  ...
  'vr3.readiness.creatingOption': 'Option wird angelegt …',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'vr3.list.card.openAria': 'Open {name}',
  ...
  'vr3.readiness.creatingOption': 'Creating Option …',
