...
const de = {
  ...
  // VR2-07 — Angebotsumfang gallery: distinct title/description/meta per
  // card, kept separate from the plain bullet labels above (still used by
  // the Versand recap lists) so neither wording is forced to serve both
  // the recap bullet and the client-safe gallery card at once.
  'presentation.artifact.offerCardTitle': 'Angebotspräsentation',
  'presentation.artifact.offerDescription': 'Projekt, Gebäude, Ergebnis, Zeitplan & Optionen',
  'presentation.artifact.offerMeta': 'PDF · 14 Seiten',
  'presentation.artifact.costCardTitle': 'Kostenübersicht DIN 276',
  'presentation.artifact.costDescription': 'KG-Struktur und kommerzielle Treiber',
  'presentation.artifact.costMeta': 'PDF + XLSX',
  'presentation.artifact.costUnavailable': 'Vorschau nicht verfügbar — Gesamtpreis noch nicht ermittelt',
  'presentation.artifact.scopeCardTitle': 'Leistungsumfang',
  'presentation.artifact.scopeDescription': 'Enthalten, nicht enthalten, Schnittstellen',
  'presentation.artifact.scopeMeta': 'PDF',
  'presentation.artifact.generating': 'Wird vorbereitet …',
  'presentation.artifact.previewAction': 'Vorschau',
  ...
  'presentation.flow.galleryHeadline': 'Drei Artefakte, eine Aussage.',
  'presentation.flow.galleryEmpty': 'Für dieses Angebot sind aktuell keine Artefakte verfügbar.',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'presentation.artifact.offerCardTitle': 'Offer presentation',
  'presentation.artifact.offerDescription': 'Project, building, result, schedule & options',
  'presentation.artifact.offerMeta': 'PDF · 14 pages',
  'presentation.artifact.costCardTitle': 'Cost overview DIN 276',
  'presentation.artifact.costDescription': 'Cost-group structure and commercial drivers',
  'presentation.artifact.costMeta': 'PDF + XLSX',
  'presentation.artifact.costUnavailable': 'Preview unavailable — total price not yet determined',
  'presentation.artifact.scopeCardTitle': 'Scope overview',
  'presentation.artifact.scopeDescription': 'Included, excluded, interfaces',
  'presentation.artifact.scopeMeta': 'PDF',
  'presentation.artifact.generating': 'Preparing …',
  'presentation.artifact.previewAction': 'Preview',
  ...
  'presentation.flow.galleryHeadline': 'Three deliverables, one statement.',
  'presentation.flow.galleryEmpty': 'No deliverables are currently available for this offer.',
