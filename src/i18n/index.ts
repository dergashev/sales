...
const de = {
  ...
  'vr3.client.entry.lede': 'Interne Notizen, Konfidenz- und Diagnosedaten, Verarbeitungsfehler und CRM-Stand sind ausgeschlossen.',
  ...
  'vr3.client.outputs.notAnOfferBody': 'PDF und Druck tragen den Hinweis „NICHT GESPEICHERTES PRÄSENTATIONS-SZENARIO — KEIN ANGENOMMENES ANGEBOT“ und nennen {option} als Quelle. Interne Notizen, Konfidenz- und Diagnosedaten sowie CRM-Stand gelangen nie in eine Kundenausgabe.',
  ...
  'vr3.client.outputs.preflight.excludes': 'Interne Notizen, Konfidenz- und Diagnosedaten, Verarbeitungsfehler und CRM-Stand sind nicht enthalten.',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'vr3.client.entry.lede': 'Internal notes, confidence and diagnostic data, processing errors and CRM state are excluded.',
  ...
  'vr3.client.outputs.notAnOfferBody': 'PDF and print carry the label “UNSAVED PRESENTATION SCENARIO — NOT AN ACCEPTED OFFER” and name {option} as the source. Internal notes, confidence and diagnostic data and CRM state never enter a client output.',
  ...
  'vr3.client.outputs.preflight.excludes': 'Internal notes, confidence and diagnostic data, processing errors and CRM state are not included.',
