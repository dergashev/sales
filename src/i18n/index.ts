...
const de = {
  ...
  'vr3.readiness.details.evidenceTitle': 'Belege je Gebäude',
  'vr3.readiness.details.proportion': '{count} von {total} Werten',
  'vr3.readiness.details.documentOutcomes': 'Dokumentergebnisse',
  'vr3.readiness.details.sourceHint': 'Jeder Wert führt zu seinem Quelldokument.',
  ...
  'vr3.client.decision.role.baseline': 'Gespeicherter Stand',
  ...
  'vr3.client.outputs.acknowledge': 'Ich bestätige, dass dieser Stand nicht gespeichert ist.',
  'vr3.client.outputs.acknowledgeFirst': 'Bitte zuerst bestätigen, dass dieser Stand nicht gespeichert ist.',
  'vr3.client.outputs.authority.saved': 'Gespeicherte Option {option} · Version {version}',
  'vr3.client.outputs.authority.scenario': 'Nicht gespeichertes Szenario · {delta} gegenüber {option} · PDF und Druck werden gekennzeichnet',
  ...
  'vr3.client.outputs.email.bodyBlocked': 'Dieses Szenario zuerst als eigene Option speichern — der Versand erzeugt einen unveränderlichen Snapshot und braucht dafür eine gespeicherte Option.',
  'vr3.client.outputs.email.gate': 'E-MAIL · GESPEICHERTE OPTION ERFORDERLICH',
  ...
  'vr3.client.outputs.lede.saved': 'Grundlage ist die gespeicherte Option {option}.',
  'vr3.client.outputs.lede.scenario': 'Das aktuelle Szenario ist nicht gespeichert. PDF und Druck erfordern eine Bestätigung; E-Mail erfordert eine gespeicherte Option.',
  ...
  'vr3.client.outputs.pdf.body': 'Kundennarrativ · gespeicherte Quelle · Szenario-Differenz · Kennzeichnung. Der Druckdialog des Browsers sichert die Datei als PDF.',
  ...
  'vr3.client.outputs.preflight.authoritySaved': 'Grundlage: gespeicherte Option {option}, Version {version}.',
  'vr3.client.outputs.preflight.authorityScenario': 'Grundlage: nicht gespeichertes Szenario auf Basis von {option}. Die Ausgabe wird entsprechend gekennzeichnet.',
  'vr3.client.outputs.preflight.contains': 'ENTHALTEN',
  'vr3.client.outputs.preflight.excludes': 'Vorbereitungsvermerke, Bewertungs- und Diagnosedaten, Verarbeitungsfehler und CRM-Stand sind nicht enthalten.',
  ...
  'vr3.client.outputs.status.failed': 'Die Ausgabe konnte nicht erzeugt werden. Es wurde nichts gesendet und nichts gespeichert.',
  ...
  'vr3.client.projectionError.action': 'Zurück zur Vorbereitung',
  'vr3.client.projectionError.body': 'Die Kalkulation kann den gespeicherten Stand im Moment nicht bestätigen. Es wird nichts angezeigt, was nicht belegt ist.',
  'vr3.client.projectionError.title': 'Diese Option lässt sich gerade nicht präsentieren',
  'vr3.client.revert.body': '{count} temporäre Änderungen werden verworfen. Die gespeicherte Option wird nicht verändert.',
  'vr3.client.revert.body.one': 'Eine temporäre Änderung wird verworfen. Die gespeicherte Option wird nicht verändert.',
  ...
  'vr3.client.save.receipt.body': 'Präsentiert wird jetzt {presented}. In der Vorbereitung bleibt {active} aktiv.',
  'vr3.client.save.receipt.dismiss': 'Verstanden',
  'vr3.client.save.receipt.title': '{option} gespeichert',
  ...
  'vr3.client.scenario.modified': 'Nicht gespeichertes Präsentations-Szenario',
  ...
  'vr3.client.schedule.duration': 'Monate von Baubeginn bis Fertigstellung',
  ...
  'vr3.client.schedule.start': 'Baubeginn',
  ...
  'vr3.client.scope.meaning.complete': 'Das Angebot umfasst Vorbereitung, Konstruktion, Technik, Außenanlagen, Ausstattung und Planungsleistungen für alle ausgewählten Gebäude.',
  ...
  'vr3.tga.decision.quantityOf': '{quantity} {unit}',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'vr3.readiness.details.evidenceTitle': 'Evidence per building',
  'vr3.readiness.details.proportion': '{count} of {total} values',
  'vr3.readiness.details.documentOutcomes': 'Document outcomes',
  'vr3.readiness.details.sourceHint': 'Every value opens its source document.',
  ...
  'vr3.client.decision.role.baseline': 'Saved baseline',
  ...
  'vr3.client.outputs.acknowledge': 'I acknowledge that this state is not saved.',
  'vr3.client.outputs.acknowledgeFirst': 'Please acknowledge first that this state is not saved.',
  'vr3.client.outputs.authority.saved': 'Saved Option {option} · version {version}',
  'vr3.client.outputs.authority.scenario': 'Unsaved scenario · {delta} versus {option} · PDF and print are labelled',
  ...
  'vr3.client.outputs.email.bodyBlocked': 'Save this scenario as its own Option first — sending creates an immutable snapshot, and a snapshot needs a saved Option.',
  'vr3.client.outputs.email.gate': 'EMAIL · SAVED OPTION REQUIRED',
  ...
  'vr3.client.outputs.lede.saved': 'The basis is the saved Option {option}.',
  'vr3.client.outputs.lede.scenario': 'The current scenario is unsaved. PDF and print require acknowledgement; email requires a saved Option.',
  ...
  'vr3.client.outputs.pdf.body': 'Client narrative · saved source · scenario delta · state label. The browser’s print dialog saves the file as PDF.',
  ...
  'vr3.client.outputs.preflight.authoritySaved': 'Basis: saved Option {option}, version {version}.',
  'vr3.client.outputs.preflight.authorityScenario': 'Basis: unsaved scenario derived from {option}. The output is labelled accordingly.',
  'vr3.client.outputs.preflight.contains': 'CONTAINS',
  'vr3.client.outputs.preflight.excludes': 'Preparation notes, assessment and diagnostic data, processing errors and CRM state are not included.',
  ...
  'vr3.client.outputs.status.failed': 'The output could not be created. Nothing was sent and nothing was saved.',
  ...
  'vr3.client.projectionError.action': 'Back to preparation',
  'vr3.client.projectionError.body': 'The calculation cannot confirm the saved state at the moment. Nothing is shown that cannot be evidenced.',
  'vr3.client.projectionError.title': 'This Option cannot be presented right now',
  'vr3.client.revert.body': '{count} temporary changes will be discarded. The saved Option is not changed.',
  'vr3.client.revert.body.one': 'One temporary change will be discarded. The saved Option is not changed.',
  ...
  'vr3.client.save.receipt.body': '{presented} is now being presented. {active} stays active in preparation.',
  'vr3.client.save.receipt.dismiss': 'Got it',
  'vr3.client.save.receipt.title': '{option} saved',
  ...
  'vr3.client.scenario.modified': 'Unsaved presentation scenario',
  ...
  'vr3.client.schedule.duration': 'months from construction start to completion',
  ...
  'vr3.client.schedule.start': 'Construction start',
  ...
  'vr3.client.scope.meaning.complete': 'The offer covers preparation, structure, technical systems, landscape, equipment and planning services for every selected building.',
