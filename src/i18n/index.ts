...
const de = {
  ...
  'presentation.flow.deliveredTitle': 'Angebot zugestellt',
  'presentation.flow.sentCopy': 'Die Zustellung wird geprüft.',
  'presentation.flow.deliveredCopy': 'Die Zustellung ist bestätigt.',
  ...
  'presentation.flow.confirmed': 'Bestätigt',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'presentation.flow.deliveredTitle': 'Offer delivered',
  'presentation.flow.sentCopy': 'Delivery is being checked.',
  'presentation.flow.deliveredCopy': 'Delivery is confirmed.',
  ...
  'presentation.flow.confirmed': 'Confirmed',
