...
const de = {
  ...
  'vr3.client.price.lede': 'Die Leitkennzahl liegt bei {rate}, bezogen auf {denominator}. Die Aufteilung folgt den Kostengruppen der DIN 276.',
  ...
  'vr3.client.overview.title': 'Das Wesentliche auf einen Blick.',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'vr3.client.price.lede': 'The lead rate is {rate}, referring to {denominator}. The breakdown follows the DIN 276 cost groups.',
  'vr3.client.price.zeroDirect': '± 0 €',
  'vr3.client.price.responsibility.all3': 'All3',
  ...
  'vr3.client.overview.title': 'The essentials at a glance.',
