...
const de = {
  ...
  /* Der Navigationsvariantenschalter: eine Lesepräferenz wie die Dichte,
     kein Modus. `v1`/`v2` sind Bezeichner und werden nicht übersetzt. */
  'shell.navVariant': 'Navigation',
  /* VR3 · Variante `v3`: der uebernommene Bauzeit-Rechner. Die Stufe ist dieselbe wie in `v2`, nur gerechnet statt geerbt. */
  'bz.heading': 'Bauzeit',
  'bz.lead': 'Der Terminplan wird gerechnet: Bruttogrundfläche, Gebäudetyp, Gebäudeklasse und Fundamentdauer sind die Eingaben, Termine und Zahlungszeitpunkte die Folge.',
  'bz.none': '—',
  'bz.unit.months': 'Mon.',
  'bz.unit.month': 'Mon.',
  'bz.gantt.paymentsCount': '{count} Tranchen',
  'bz.legend.shell': 'Rohbau',
  'bz.legend.fitout': 'Ausbau',
  'bz.unit.weeks': 'Wo.',
  'bz.unit.area': 'm²',
  'bz.params.title': 'Projekt-Parameter',
  'bz.field.start': 'Projektbeginn',
  'bz.field.startHint': 'Monat 0. Ab hier werden alle Termine gerechnet.',
  'bz.field.planningEnabled': 'Planungsphase einrechnen',
  'bz.field.planningHint': 'Einmalige Planungs- und Genehmigungsphase vor dem Bau. Ohne sie beginnt der Bau mit den Fundamentarbeiten.',
  'bz.field.interval': 'Zeitversatz der Baustarts',
  'bz.field.intervalHint': 'Wie viel später jedes weitere Gebäude startet — Ressourcen und Baukolonnen.',
  'bz.field.bgf': 'Bruttogrundfläche (BGF)',
  'bz.field.type': 'Gebäudetyp',
  'bz.field.gk': 'Gebäudeklasse (GK)',
  'bz.field.foundation': 'Fundamentarbeiten',
  'bz.field.foundationHint': 'Läuft unmittelbar vor dem Baustart dieses Gebäudes.',
  'bz.result.title': 'Ergebnis',
  'bz.result.duration': 'Gesamte Projektdauer',
  'bz.result.durationSplit': 'Planung {planning} + Bau {construction}',
  'bz.result.durationNoPlanning': 'Ohne Planungsphase gerechnet.',
  'bz.result.completion': 'Fertigstellung',
  'bz.result.buildings': 'Gebäude',
  'bz.result.planningTotal': 'Planung gesamt',
  'bz.result.contractSum': 'Gesamtvertragssumme',
  'bz.result.contractSumOrigin': 'Aus der KG-Konfiguration dieser Option; auf die Gebäude nach BGF verteilt.',
  'bz.gantt.title': 'Zeitplan',
  'bz.gantt.payments': 'Zahlungsmeilensteine',
  'bz.gantt.axis': 'Monat',
  'bz.stage.s0': 'Vertragsunterzeichnung',
  'bz.stage.s1': 'Entwurfsplanung (LP4)',
  'bz.stage.s2': 'Genehmigungsplanung',
  'bz.stage.s3': 'Ausführungsplanung (LP5)',
  'bz.stage.s4': 'Fundamentarbeiten',
  'bz.phase.foundation': 'Fundamentarbeiten',
  'bz.phase.construction': 'Rohbau + Ausbau',
  'bz.phase.acceptance': 'Bauabnahme',
  'bz.type.single': 'Einfamilienhaus',
  'bz.type.mfh': 'Mehrfamilienhaus (MFH)',
  'bz.type.campus': 'Campus',
  'bz.buildings.title': 'Gebäude ({count})',
  'bz.buildings.empty': 'Für diese Option ist kein Gebäude ausgewählt.',
  'bz.origin.fromBuilding': 'Aus dem Gebäude der Option übernommen.',
  'bz.origin.edited': 'Für den Terminplan angepasst.',
  'bz.origin.proposedFromUsage': 'Vorschlag aus der Nutzung — überschreibbar.',
  'bz.origin.proposedFromStoreys': 'Vorschlag aus der Geschossigkeit — überschreibbar.',
  'bz.card.onsite': 'Bauzeit (vor Ort)',
  'bz.card.window': 'Start → Ende',
  'bz.card.split': 'Rohbau · Ausbau',
  'bz.card.splitValue': 'Rohbau {rohbau} · Ausbau {ausbau}',
  'bz.card.contractSum': 'Vertragssumme des Gebäudes',
  'bz.card.why': 'Warum diese Bauzeit?',
  'bz.card.whyCaption': 'Herleitung der Bauzeit von {building}',
  'bz.why.base': 'Basis',
  'bz.why.baseExplain': '{ref} Monate bei {area} m², je weitere {perMonth} m² ein Monat.',
  'bz.why.type': 'Typ',
  'bz.why.gk': 'Gebäudeklasse',
  'bz.why.result': 'Bauzeit vor Ort',
  'bz.why.resultExplain': 'Basis mal Typ- und Klassenfaktor.',
  'bz.why.minApplied': 'Mindestbauzeit {min} greift — die Formel ergäbe weniger.',
  'bz.payments.title': 'Zahlungsplan ({count} Tranchen)',
  'bz.payments.sharesWarning': 'Anteile ergeben nicht 100 Prozent',
  'bz.payments.sharesReason': 'Anzahlung und gebäudebezogene Anteile zusammen sind nicht die Vertragssumme.',
  'bz.payments.caption': 'Zahlungsmeilensteine mit Fälligkeit, Anteil und Bemessungsgrundlage',
  'bz.payments.milestone': 'Meilenstein',
  'bz.payments.building': 'Gebäude',
  'bz.payments.due': 'Fälligkeit',
  'bz.payments.share': 'Anteil',
  'bz.payments.basis': 'Bemessungsgrundlage',
  'bz.payments.amount': 'Tranche',
  'bz.payments.basisProject': 'Gesamtvertragssumme',
  'bz.payments.next': 'Nächste Zahlung',
  'bz.payments.total': 'Summe',
  'bz.payment.design': 'Anzahlung nach Vertragsunterzeichnung',
  'bz.payment.shell': 'Zahlung nach Abschluss Rohbau',
  'bz.payment.fitout': 'Zahlung nach Abschluss Ausbau',
  'bz.payment.acceptance': 'Zahlung nach Bauabnahme',
  'bz.settings.title': 'Modelleinstellungen',
  'bz.settings.formula': 'Basisformel',
  'bz.settings.refArea': 'Referenzfläche',
  'bz.settings.refMonths': 'Referenzdauer',
  'bz.settings.areaPerMonth': 'Fläche pro Monat',
  'bz.settings.minMonths': 'Mindestbauzeit',
  'bz.settings.typeFactors': 'Typ-Faktoren',
  'bz.settings.gkFactors': 'Gebäudeklassen-Faktoren',
  'bz.settings.planning': 'Planungsphasen',
  'bz.settings.p1Base': 'LP4-Basiszeit',
  'bz.settings.p1Threshold': 'LP4-Flächenschwelle',
  'bz.settings.p1Step': 'LP4-Flächenschritt',
  'bz.settings.p1StepAdd': 'LP4-Zeitschritt',
  'bz.settings.p4Offset': 'Versatz Fundamentstart',
  'bz.settings.phases': 'Phasen',
  'bz.settings.rohbauPct': 'Rohbau',
  'bz.settings.ausbauPct': 'Ausbau',
  'bz.settings.payments': 'Zahlungsanteile',
  'bz.settings.pctDesign': 'Anzahlung',
  'bz.settings.pctShell': 'Nach Rohbau',
  'bz.settings.pctFitout': 'Nach Ausbau',
  'bz.settings.pctAcceptance': 'Nach Bauabnahme',
  'bz.settings.reset': 'Auf Standard zurücksetzen',
  'bz.confirm': 'Terminplan bestätigen',
  'bz.confirm.blocked': 'Zuerst die benannten Termindaten klären.',
  'bz.toValidation': 'Weiter zur Endprüfung',
  'vr3.journal.bauzeitBuildingParam': 'Terminmodell: Gebäudeparameter geändert',
  'vr3.journal.bauzeitModel': 'Terminmodell: Kalibrierung geändert',
  'vr3.journal.bauzeitModelReset': 'Terminmodell: Kalibrierung zurückgesetzt',
  /* Der Neustart der Demonstration: verwirft gespeicherte Optionen und
     Analysen, behält Sprache und Navigationsvariante. */
  'shell.reset': 'Prototyp zurücksetzen',
  ...
  /* Die Qualifikation des Hero-Betrags, seit die Basiszeile fort ist: WIE
     VOLLSTÄNDIG kalkuliert wurde (`coverage`, die modellierte Achse — kein
     Konfidenzgrad, den SOURCE-001 als Feld verbietet) und WIE BREIT das
     Intervall ist. Das Wort trägt den Zustand, die Farbe wiederholt ihn nur
     (Regel 8). */
  'offerPanel.basis.title': 'Konfidenz',
  'offerPanel.basis.level': 'Hoch',
  ...
  'vr3.kg.ledger.caption':
    'Leistungsabgrenzung: drei Kostengruppen, je im Angebot oder ausgenommen.',
  ...
  'vr3.kg.ledger.footerIncomplete':
    'Die Konfiguration der Kostengruppen bleibt gesperrt, bis alle drei Entscheidungen ausdrücklich getroffen sind.',
  ...
  'vr3.kg.ledger.announceComplete':
    'Alle drei Entscheidungen sind getroffen. Die erste enthaltene Kostengruppe ist verfügbar.',
  ...
  'ds.authority.overridden': 'manuell erfasst',
  ...
  /* Die Grundlage einer Ein-Gebäude-Option: mit der Option bestätigt, hier
     sichtbar und von hier aus änderbar. */
  'vr3.scope.base.label': 'Grundlage',
  ...
  'vr3.konfigurator.receipt.next':
    'Nächster Schritt: für die drei offenen Kostengruppen entscheiden, ob sie enthalten sind.',
  ...
  'vr3.understanding.goToOptions': 'Zu den Optionen',
  'vr3.understanding.goToOptions.demo': 'Alles lösen und weiter (Demo)',
  'vr3.understanding.goToOptions.blocked': 'Alle Angaben müssen bestätigt sein.',
  'vr3.understanding.goToOptions.derived': '{count} berechnet',
  'vr3.understanding.goToOptions.conflicts': '{count} strittige Angaben',
  'vr3.understanding.goToOptions.questions': '{count} offene Fragen',
  'vr3.understanding.goToOptions.stale': '{count} erneut zu prüfen',
  ...
  'vr3.option.baseName': 'Basisoption',
  'vr3.journey.optionLabel': 'Schritte der Option',
  'vr3.journey.optionNone': 'Noch keine Option',
  'comparison.rows.legend': 'Zeilen',
  'comparison.rows.all': 'alle Zeilen',
  'vr3.option.delete': 'Löschen',
  ...
  'portfolio.filter.client.label': 'Kunde',
  ...
  'portfolio.filter.chip.client': 'Kunde: {value}',
  ...
  'portfolio.card.rate': 'Kosten je m²',
  ...
  'vr3.journal.evidenceConfirmed': 'Wert bestätigt · {item}',
  'vr3.journal.evidenceOverridden': 'Wert manuell erfasst · {item}',
  'vr3.journal.evidenceOverrideCleared': 'Eigener Wert verworfen · {item}',
  'vr3.journal.questionAssumed': 'Offene Frage {question} · Annahme dokumentiert',
  'vr3.journal.optionCreated': 'Option «{option}» angelegt',
  'vr3.journal.optionDeleted': 'Option «{option}» gelöscht',
  ...
  'vr3.analysis.action.inspect': 'Vorschau',
  ...
  'vr3.analysis.start.scoped': 'Alle {count} Dokumente analysieren',
  'vr3.documents.title': 'Dokumente',
  'vr3.documents.origin': 'Aus {link} übernommen.',
  'vr3.documents.origin.folder': 'Projektordner des Kunden',
  ...
  'vr3.decisions.state.open': 'Offen',
  'vr3.decisions.state.answered': 'Beantwortet',
  'vr3.decisions.source': '{authority} · {file} · {version}',
  'vr3.decisions.mark.older': 'ältere Quelle',
  'vr3.decisions.mark.manual': 'weder noch',
  'vr3.decisions.manualNote': 'Manuell erfasst · keine der beiden Quellen',
  'vr3.decisions.sourceWithFlag': '{flag} · {source}',
  'vr3.decisions.confirm': 'Bestätigen',
  'vr3.checklist.filter.label': 'Anzeigen',
  'vr3.checklist.filter.all': 'Alle · {count}',
  'vr3.checklist.filter.conflicts': 'Strittige Angaben · {count}',
  'vr3.checklist.filter.questions': 'Offene Fragen · {count}',
  'vr3.checklist.filter.derived': 'Abgeleitet · {count}',
  'vr3.evidence.title': 'Projekt-Checkliste',
  ...
  'vr3.evidence.groupTotal': '{total} Angaben',
  ...
  'vr3.evidence.openSource': 'Quelle öffnen',
  ...
  'vr3.evidence.viewer.close': 'Schließen',
  'vr3.evidence.viewer.confirmValue': 'Wert bestätigen',
  'vr3.evidence.viewer.customValue': 'Eigener Wert',
  'vr3.evidence.edit': 'Bearbeiten',
  'vr3.evidence.edit.legend': 'Wert für {label}',
  'vr3.evidence.edit.fromDocument': 'Aus dem Dokument',
  'vr3.evidence.edit.fromDocumentValue': 'Aus dem Dokument: {value}',
  'vr3.evidence.edit.custom': 'Eigener Wert',
  'vr3.evidence.edit.apply': 'Übernehmen',
  'vr3.evidence.viewer.customValueLabel': 'Eigener Wert für {label}',
  'vr3.evidence.viewer.customValueHint': 'Ersetzt den erkannten Wert {value}. Der erkannte Wert bleibt auf der Zeile sichtbar.',
  'vr3.evidence.viewer.customValueConfirm': 'Eigenen Wert übernehmen',
  'vr3.evidence.viewer.customValueEmpty': 'Erst einen Wert eingeben.',
  'vr3.evidence.viewer.cancel': 'Abbrechen',
  'vr3.evidence.override.manualReason': 'Manuell erfasst',
  'vr3.evidence.checkInSource': 'Im Dokument prüfen',
  'vr3.evidence.checkInSourceOn': '{label} · im Dokument prüfen und bestätigen · {file}',
  ...
  'vr3.spine.step.understanding': 'Projekt-Checkliste',
  ...
  'vr3.review.group.costGroups': 'KG 300 · 400 · 700',
  ...
  'vr3.review.section.scopeDecisions': 'Leistungsabgrenzung — drei Entscheidungen',
  ...
  /* Die Zusammenfassungszeile bleibt und klappt auf (Owner, 16.09.2026):
     der Zählstand sagt, wie viel es ist, die Liste darunter sagt, was es
     ist. Der Name der Zeile steht IM Schlüssel als Wert, nicht davor
     geklebt — Regel 36 verbietet die Verkettung, nicht den Platzhalter. */
  'vr3.review.details.expand': '{label} im Einzelnen anzeigen',
  'vr3.review.details.collapse': '{label} im Einzelnen ausblenden',
  'vr3.review.details.edit': 'Bearbeiten',
  ...
  /* Die eine Bestätigung im Dock nennt den Abschnitt, den sie bestätigt —
     sie steht nicht mehr neben ihm. */
  ...
  'vr3.save.prereq.confirmFirst': 'Zuerst die Prüfung bestätigen.',
  ...
  'vr3.journal.reviewAllAcknowledged': 'Prüfbogen geprüft · {count} Abschnitte',
  ...
  'commercial.din.baselineRest': 'Übrige Kostengruppen · Basisumfang',
  ...
  'vr3.matrix.caption': 'Schnittstellenmatrix · Zuordnung je Position',
  'vr3.matrix.column.position': 'Nr. · Leistung',
  'vr3.matrix.column.notRequired': 'Nicht erford.',
  'vr3.matrix.column.ag': 'AG',
  'vr3.matrix.column.an': 'AN (GU/GÜ)',
  'vr3.matrix.positions': '{count} Positionen aus der Schnittstellenmatrix',
  'vr3.matrix.groupCount': '{rows} Positionen · {assigned} zugeordnet',
  'vr3.matrix.expandAll': 'Alle aufklappen',
  'vr3.matrix.collapseAll': 'Alle zuklappen',
  'vr3.journal.interfaceMark': 'Schnittstellenmatrix {nr} geändert',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'shell.navVariant': 'Navigation',
  /* VR3 variant `v3`: the adopted construction-period calculator. */
  'bz.heading': 'Construction period',
  'bz.lead': 'The schedule is derived: gross floor area, building type, building class and foundation duration are the inputs; dates and payment points follow from them.',
  'bz.none': '—',
  'bz.unit.months': 'months',
  'bz.unit.month': 'month',
  'bz.gantt.paymentsCount': '{count} instalments',
  'bz.legend.shell': 'Shell',
  'bz.legend.fitout': 'Fit-out',
  'bz.unit.weeks': 'weeks',
  'bz.unit.area': 'm²',
  'bz.params.title': 'Project parameters',
  'bz.field.start': 'Project start',
  'bz.field.startHint': 'Month 0. Every date is counted from here.',
  'bz.field.planningEnabled': 'Include the planning phase',
  'bz.field.planningHint': 'One planning and permit phase before construction. Without it, construction starts with the foundation works.',
  'bz.field.interval': 'Stagger between construction starts',
  'bz.field.intervalHint': 'How much later each further building starts — resources and site crews.',
  'bz.field.bgf': 'Gross floor area (BGF)',
  'bz.field.type': 'Building type',
  'bz.field.gk': 'Building class (GK)',
  'bz.field.foundation': 'Foundation works',
  'bz.field.foundationHint': 'Runs immediately before this building starts.',
  'bz.result.title': 'Result',
  'bz.result.duration': 'Total project duration',
  'bz.result.durationSplit': 'Planning {planning} + construction {construction}',
  'bz.result.durationNoPlanning': 'Calculated without the planning phase.',
  'bz.result.completion': 'Completion',
  'bz.result.buildings': 'Buildings',
  'bz.result.planningTotal': 'Planning total',
  'bz.result.contractSum': 'Total contract sum',
  'bz.result.contractSumOrigin': 'From this Option\'s cost-group configuration; split across the buildings by gross floor area.',
  'bz.gantt.title': 'Schedule',
  'bz.gantt.payments': 'Payment milestones',
  'bz.gantt.axis': 'Month',
  'bz.stage.s0': 'Contract signing',
  'bz.stage.s1': 'Design phase (LP4)',
  'bz.stage.s2': 'Permit planning',
  'bz.stage.s3': 'Execution planning (LP5)',
  'bz.stage.s4': 'Foundation works',
  'bz.phase.foundation': 'Foundation works',
  'bz.phase.construction': 'Shell + fit-out',
  'bz.phase.acceptance': 'Handover inspection',
  'bz.type.single': 'Single-family house',
  'bz.type.mfh': 'Apartment building (MFH)',
  'bz.type.campus': 'Campus',
  'bz.buildings.title': 'Buildings ({count})',
  'bz.buildings.empty': 'No building is selected for this Option.',
  'bz.origin.fromBuilding': 'Taken from the Option\'s building.',
  'bz.origin.edited': 'Adjusted for the schedule.',
  'bz.origin.proposedFromUsage': 'Proposed from the use — can be overridden.',
  'bz.origin.proposedFromStoreys': 'Proposed from the storeys — can be overridden.',
  'bz.card.onsite': 'Construction period (on site)',
  'bz.card.window': 'Start → end',
  'bz.card.split': 'Shell · fit-out',
  'bz.card.splitValue': 'Shell {rohbau} · fit-out {ausbau}',
  'bz.card.contractSum': 'Building\'s contract sum',
  'bz.card.why': 'Why this construction period?',
  'bz.card.whyCaption': 'How the construction period of {building} is derived',
  'bz.why.base': 'Base',
  'bz.why.baseExplain': '{ref} months at {area} m²; one further month per {perMonth} m².',
  'bz.why.type': 'Type',
  'bz.why.gk': 'Building class',
  'bz.why.result': 'Construction period on site',
  'bz.why.resultExplain': 'Base times the type and class factors.',
  'bz.why.minApplied': 'The minimum of {min} applies — the formula would give less.',
  'bz.payments.title': 'Payment schedule ({count} instalments)',
  'bz.payments.sharesWarning': 'Shares do not add up to 100 per cent',
  'bz.payments.sharesReason': 'The deposit and the building shares together are not the contract sum.',
  'bz.payments.caption': 'Payment milestones with due date, share and basis',
  'bz.payments.milestone': 'Milestone',
  'bz.payments.building': 'Building',
  'bz.payments.due': 'Due',
  'bz.payments.share': 'Share',
  'bz.payments.basis': 'Basis',
  'bz.payments.amount': 'Instalment',
  'bz.payments.basisProject': 'Total contract sum',
  'bz.payments.next': 'Next payment',
  'bz.payments.total': 'Total',
  'bz.payment.design': 'Deposit after contract signing',
  'bz.payment.shell': 'Payment after the shell is complete',
  'bz.payment.fitout': 'Payment after the fit-out is complete',
  'bz.payment.acceptance': 'Payment after the handover inspection',
  'bz.settings.title': 'Model settings',
  'bz.settings.formula': 'Base formula',
  'bz.settings.refArea': 'Reference area',
  'bz.settings.refMonths': 'Reference duration',
  'bz.settings.areaPerMonth': 'Area per month',
  'bz.settings.minMonths': 'Minimum construction period',
  'bz.settings.typeFactors': 'Type factors',
  'bz.settings.gkFactors': 'Building-class factors',
  'bz.settings.planning': 'Planning phases',
  'bz.settings.p1Base': 'LP4 base duration',
  'bz.settings.p1Threshold': 'LP4 area threshold',
  'bz.settings.p1Step': 'LP4 area step',
  'bz.settings.p1StepAdd': 'LP4 time step',
  'bz.settings.p4Offset': 'Foundation start offset',
  'bz.settings.phases': 'Phases',
  'bz.settings.rohbauPct': 'Shell',
  'bz.settings.ausbauPct': 'Fit-out',
  'bz.settings.payments': 'Payment shares',
  'bz.settings.pctDesign': 'Deposit',
  'bz.settings.pctShell': 'After the shell',
  'bz.settings.pctFitout': 'After the fit-out',
  'bz.settings.pctAcceptance': 'After the handover inspection',
  'bz.settings.reset': 'Reset to defaults',
  'bz.confirm': 'Confirm the schedule',
  'bz.confirm.blocked': 'Settle the named schedule data first.',
  'bz.toValidation': 'Continue to final validation',
  'vr3.journal.bauzeitBuildingParam': 'Schedule model: building parameter changed',
  'vr3.journal.bauzeitModel': 'Schedule model: calibration changed',
  'vr3.journal.bauzeitModelReset': 'Schedule model: calibration reset',
  'shell.reset': 'Reset prototype',
  'shell.account.name': 'Daniel Weber',
  ...
  'offerPanel.basis.title': 'Confidence',
  'offerPanel.basis.level': 'High',
  ...
  /* ── VR3-03 · unified Konfigurator (T-018–T-028) ──────────────────── */
  'vr3.kg.ledger.caption':
    'Scope decisions: three cost groups, each in the offer or taken out.',
  'vr3.kg.ledger.column.group':
    'Cost group',
  'vr3.kg.ledger.column.decision':
    'Decision',
  ...
  'vr3.kg.ledger.downstream.required':
    'Decision required',
  'vr3.kg.ledger.footerIncomplete':
    'Cost-group configuration stays locked until all three decisions are explicit.',
  'vr3.kg.ledger.footerComplete':
  ...
  'vr3.kg.ledger.announceComplete':
    'All three decisions are made. The first included cost group is available.',
  'vr3.kg.ledger.recheck':
    'Confirm again',
  'vr3.kg.ledger.recheckReason':
  ...
  'ds.authority.overridden': 'entered manually',
  ...
  'vr3.konfigurator.receipt.next':
    'Next step: decide for the three open cost groups whether they are in scope.',
  ...
  'vr3.understanding.goToOptions': 'Go to Options',
  'vr3.understanding.goToOptions.demo': 'Resolve everything and continue (demo)',
  'vr3.understanding.goToOptions.blocked': 'All values must be confirmed.',
  'vr3.understanding.goToOptions.derived': '{count} derived',
  'vr3.understanding.goToOptions.conflicts': '{count} conflicts',
  'vr3.understanding.goToOptions.questions': '{count} open questions',
  'vr3.understanding.goToOptions.stale': '{count} to re-check',
  ...
  'vr3.option.baseName': 'Base option',
  'vr3.journey.optionLabel': 'Steps of the Option',
  'vr3.journey.optionNone': 'No Option yet',
  'comparison.rows.legend': 'Rows',
  'comparison.rows.all': 'all rows',
  'vr3.option.delete': 'Delete',
  ...
  'portfolio.filter.client.label': 'Client',
  ...
  'portfolio.filter.chip.client': 'Client: {value}',
  ...
  'portfolio.card.rate': 'Cost per m²',
  ...
  'vr3.journal.evidenceConfirmed': 'Value confirmed · {item}',
  'vr3.journal.evidenceOverridden': 'Value entered manually · {item}',
  'vr3.journal.evidenceOverrideCleared': 'Custom value withdrawn · {item}',
  'vr3.journal.questionAssumed': 'Open question {question} · assumption documented',
  'vr3.journal.optionCreated': 'Option «{option}» created',
  'vr3.journal.optionDeleted': 'Option «{option}» deleted',
  ...
  'vr3.analysis.action.inspect': 'Preview',
  ...
  'vr3.analysis.start.scoped': 'Analyse all {count} documents',
  'vr3.documents.title': 'Documents',
  'vr3.documents.origin': 'Imported from {link}.',
  'vr3.documents.origin.folder': 'the client project folder',
  ...
  'vr3.evidence.label.facade': 'Facade',
  ...
  'vr3.decisions.state.open': 'Open',
  'vr3.decisions.state.answered': 'Answered',
  'vr3.decisions.source': '{authority} · {file} · {version}',
  'vr3.decisions.mark.older': 'older source',
  'vr3.decisions.mark.manual': 'neither',
  'vr3.decisions.manualNote': 'Entered manually · neither source',
  'vr3.decisions.sourceWithFlag': '{flag} · {source}',
  'vr3.decisions.confirm': 'Confirm',
  'vr3.checklist.filter.label': 'Show',
  'vr3.checklist.filter.all': 'All · {count}',
  'vr3.checklist.filter.conflicts': 'Conflicting values · {count}',
  'vr3.checklist.filter.questions': 'Open questions · {count}',
  'vr3.checklist.filter.derived': 'Derived · {count}',
  'vr3.evidence.title': 'Project checklist',
  ...
  'vr3.evidence.groupTotal': '{total} values',
  ...
  'vr3.evidence.openSource': 'Open source',
  ...
  'vr3.evidence.viewer.close': 'Close',
  'vr3.evidence.viewer.confirmValue': 'Confirm value',
  'vr3.evidence.viewer.customValue': 'Custom value',
  'vr3.evidence.edit': 'Edit',
  'vr3.evidence.edit.legend': 'Value for {label}',
  'vr3.evidence.edit.fromDocument': 'From the document',
  'vr3.evidence.edit.fromDocumentValue': 'From the document: {value}',
  'vr3.evidence.edit.custom': 'Custom value',
  'vr3.evidence.edit.apply': 'Apply',
  'vr3.evidence.viewer.customValueLabel': 'Custom value for {label}',
  'vr3.evidence.viewer.customValueHint': 'Replaces the extracted value {value}. The extracted value stays visible on the row.',
  'vr3.evidence.viewer.customValueConfirm': 'Apply custom value',
  'vr3.evidence.viewer.customValueEmpty': 'Enter a value first.',
  'vr3.evidence.viewer.cancel': 'Cancel',
  'vr3.evidence.override.manualReason': 'Entered manually',
  'vr3.evidence.checkInSource': 'Check in the document',
  'vr3.evidence.checkInSourceOn': '{label} · check in the document and confirm · {file}',
  ...
  'vr3.spine.step.understanding': 'Project checklist',
  ...
  'vr3.review.section.scopeDecisions': 'Scope decisions — three of three',
  ...
  'vr3.review.details.expand': 'Show {label} in detail',
  'vr3.review.details.collapse': 'Hide {label} in detail',
  'vr3.review.details.edit': 'Edit',
  ...
  'vr3.save.prereq.confirmFirst': 'Confirm validation first.',
  ...
  'vr3.journal.reviewAllAcknowledged': 'Review sheet reviewed · {count} sections',
  ...
  'vr3.matrix.caption': 'Interface matrix · assignment per position',
  'vr3.matrix.column.position': 'No. · Service',
  'vr3.matrix.column.notRequired': 'Not required',
  'vr3.matrix.column.ag': 'Client (AG)',
  'vr3.matrix.column.an': 'Contractor (AN)',
  'vr3.matrix.positions': '{count} positions from the interface matrix',
  'vr3.matrix.groupCount': '{rows} positions · {assigned} assigned',
  'vr3.matrix.expandAll': 'Expand all',
  'vr3.matrix.collapseAll': 'Collapse all',
  'vr3.journal.interfaceMark': 'Interface matrix {nr} changed',
  'vr3.responsibility.legacy':
  ...
  'commercial.din.baselineRest': 'Other cost groups · baseline',
