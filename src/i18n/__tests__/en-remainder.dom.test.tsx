 ...
 * карточки объёма, и у карточек появились три новых немецких пояснения
 * («Entscheidung, keine Lücke…», «Lücke, keine Entscheidung…»,
 * «Zwischensumme statt Gesamtpreis»). Немецкий — язык-источник, поэтому
 * новая копия сначала появляется на нём: строки уходят в поставку № 5.
 * Храповик сработал как задуман — рост не прошёл молча.
 */
const BUDGET = 80
