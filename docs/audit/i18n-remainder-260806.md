...
| `src/screens/S3Konfigurator.tsx` | Nächster Schritt |
| `src/screens/S3Konfigurator.tsx` | Varianten vergleichen |
| `src/screens/S4Vergleich.tsx` | Angebot prüfen und exportieren |
| `src/screens/S4Vergleich.tsx` | Die aktive Option ist verglichen — weiter zur Prüfung und zum Versand des Angebots. |
| `src/screens/S4Vergleich.tsx` | Gebäude im Angebot |
...
| `src/screens/S4Vergleich.tsx` | Nächster Schritt |
| `src/screens/S4Vergleich.tsx` | Option |
| `src/screens/S4Vergleich.tsx` | Optionen |
| `src/screens/S4Vergleich.tsx` | Rollen sind unabhängige Text-Badges: Deltas rechnen zur benannten Vergleichsbasis (VARIANT-001, XSC-08). |
| `src/screens/S4Vergleich.tsx` | Vergleich der Opportunity Options |
| `src/screens/S4Vergleich.tsx` | Zum Vergleichen braucht es eine zweite Option. Sie entsteht auf der Opportunity-Karte — mit eigener Konfiguration, unabhängig von dieser. |
| `src/screens/S4Vergleich.tsx` | Zur Opportunity-Karte |
| `src/screens/S4Vergleich.tsx` | im All3-Verfahren 70/22/8 verteilt |
| `src/screens/S4Vergleich.tsx` | nach HOAI und AHO als eigene Position |
| `src/screens/S4Vergleich.tsx` | · Vergleichsbasis |
| `src/screens/S4Vergleich.tsx` | · in Arbeit |
